        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-14">
            ...
            <div className="flex-1 text-center md:text-left order-last md:order-first">
              ...
              >
                I build scalable backend systems that products can rely on.
              </motion.h1>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.4, duration: 0.6 }}
                className="text-lg md:text-xl font-medium text-white/80 mb-8 max-w-2xl"
              >
                I design APIs, authentication flows, and production-ready
                architecture for web applications that need to scale with
                confidence.
              </motion.p>
              ...
              >
                ...
                >
                  View Backend Work <ChevronRight className="w-4 h-4" />
                </button>
                <button
                  type="button"
